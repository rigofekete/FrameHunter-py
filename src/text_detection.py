...
class TextDetector:
    def __init__(self):
        ...
        self.ocr_config = '--psm 10 -c tessedit_char_whitelist=ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789 '
    ...
    def setup_char_database(self):
        ...
        self.conn = sqlite3.connect(f'{DB_PATH}\\char_detections.db')

        cursor = self.conn.cursor()
        
        # Create table for MF detections
        cursor.execute('''
